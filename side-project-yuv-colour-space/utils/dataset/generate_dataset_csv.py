...
def main():
    ...
    with open(OUTPUT_CSV, 'w', newline='') as csvfile:
        ...
        for img_file in tqdm.tqdm(list(DATA_DIR.rglob('*.png')), desc="Processing samples"):
            ...
            linear_r, linear_g, linear_b = convert_srgb_to_linear(mode_r / 255.0, mode_g / 255.0, mode_b / 255.0)
