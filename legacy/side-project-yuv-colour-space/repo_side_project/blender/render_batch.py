...
# --- Load CSV ---
csv_path = "/Users/boting/li_4yp/side-project-yuv-colour-space/data/renders/v01/pred_renders_srgb_v01.csv"
output_folder = "/Users/boting/li_4yp/side-project-yuv-colour-space/blender/output"

testable_shades = ["10.01", "10.02", "10.002", "10.004", "10.009"]
...
with open(csv_path, newline="") as csvfile:
    ...
    for row in reader:
        ...
        render_id = row[0].strip().split("_")[0]

        # render testable shades
        if render_id not in testable_shades:
            continue
